      ...
      <div className="">
        ...
        <div className="px-5 md:px-40 py-20">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mt-10 md:mt-0 flex justify-center items-center"><Image src="/About/Christoph.png" alt="card" className='rounded-full' width="250px" height="250px" /></div>
            <div className="mt-10 md:mt-0 flex justify-center items-center"><Image src="/About/Christoph.png" alt="card" className='rounded-full' width="250px" height="250px" /></div>
            <div className="mt-10 md:mt-0 flex justify-center items-center"><Image src="/About/Christoph.png" alt="card" className='rounded-full' width="250px" height="250px" /></div>
          </div>
        </div>
