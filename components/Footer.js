...
const Footer = () => {
  return (
    <div className='p-10 bg-sky-600 text-white'>
        <div className="text-5xl font-yaro mb-10 md:pl-20 lg:36 xl:pl-44 text-center md:text-left">lipa</div>
        <div className="flex flex-col md:flex-row justify-evenly items-center text-xl font-medium">
            ...
            <div className="md:border-l-2 md:border-white md:pl-10 lg:20 xl:pl-32 mt-10 md:mt-0 text-center md:text-left">
